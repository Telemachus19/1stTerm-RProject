...
- We make the data suitable for apriori's algorithm by
    - Splitting the transactions's entries into separate items and transforming it into a transactions object

## importing the library we are going to use


```{r importing the libraries, message=FALSE, warning=FALSE}
library(dplyr)
library(ggplot2)
library(forcats)
library(arules)
